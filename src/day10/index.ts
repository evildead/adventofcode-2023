...
As you stop to admire some metal grass, you notice something metallic scurry away in your
peripheral vision and jump into a big pipe! It didn't look like any animal you've ever seen;
...
the "ground". You make a quick sketch of all of the surface pipes you can see (your puzzle input).
...
outside the loop - squeezing between pipes is also allowed! Here, I is still within the loop and
O is still outside the loop:
